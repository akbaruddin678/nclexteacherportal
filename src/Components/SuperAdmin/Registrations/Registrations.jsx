...
const Registration = ({ initialTab = "principal" }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (activeTab === "principal") requiredFields.push("phone", "department", "cnic", "salary");
  ...
  return (
    <div className="registration">
      <div className="page-header">
        ...
        <p>Register principals, teachers, and students</p>
      </div>

      <div className="registration-tabs">
        <button className={`tab-btn ${activeTab === "principal" ? "active" : ""}`} onClick={() => handleTabChange("principal")}><MdPerson /> Principal</button>
          ...
          <>
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <input type="text" value={formData.department} onChange={(e) => handleInputChange("department", e.target.value)} required />
              </div>
            </div>
            <div className="form-row">
              <div className="form-group">
